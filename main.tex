...
% Show contents at the beginning of the section
\AtBeginSection[]
{
	\begin{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[height=1.6cm]{imagenes/Logo_UC3M.svg.png}
	\end{center}
\end{frame}

% Logo at the corner after the front page
\logo{\includegraphics[height=1cm]{imagenes/Acronimo_nombre3l.jpg}}
...
\begin{center}
\vspace{1.2cm}
\includegraphics[width=0.6\textwidth]{imagenes/creativecommons.png}
\end{center}
\end{figure}
\end{frame}
